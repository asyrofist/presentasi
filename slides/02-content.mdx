...
- Bagaimana cara kerja Doc2vec? 👏
  [more..](https://docs.google.com/presentation/d/1O0E7MSXf-KOGmXD05FlminhMrGlvBINZcYu-crI45vQ/edit?usp=sharing)
    ...
    def vectorize(self, doc: str) -> np.ndarray:
        ...
        for word in words:
            try:
                ...
                pass # Ignore, if the word doesn't exist in the vocabulary
